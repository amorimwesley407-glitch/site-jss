    ...
    <section id="planos" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <p className="text-primary font-medium mb-4">Planos e Preços</p>
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-6">
            Escolha o plano{" "}
            <span className="gradient-text">ideal para você</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            Planos flexíveis que se adaptam às suas necessidades. Sem fidelidade.
          </p>
        </div>
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-primary font-semibold text-lg mb-4">{plan.speed}</p>
              ...
              {/* CTA */}
              <a href="https://api.whatsapp.com/send/?phone=551151988001&text%20%20%20=
              Ol%C3%A1%21+Gostaria+de+saber+mais+sobre+os+planos+da+NetConnect.%20%20%20&type=
        ...
        <p className="text-center text-muted-foreground text-sm mt-12">
          Todos os planos incluem instalação gratuita e não possuem fidelidade.
